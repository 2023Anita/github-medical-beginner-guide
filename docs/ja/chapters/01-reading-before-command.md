---
title: "1-2. コマンドより先にプロジェクトを読む"
description: "1-2. コマンドより先にプロジェクトを読む"
---

# 1-2. コマンドより先にプロジェクトを読む

![1-2. コマンドより先にプロジェクトを読む](/assets/illustrations/04-repository-reading-order.png)
