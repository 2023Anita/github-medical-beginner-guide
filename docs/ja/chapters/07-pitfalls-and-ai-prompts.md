---
title: "12-13. つまずきやすい点と AI プロンプト"
description: "12-13. つまずきやすい点と AI プロンプト"
---

# 12-13. つまずきやすい点と AI プロンプト

![12-13. つまずきやすい点と AI プロンプト](/assets/illustrations/04-repository-reading-order.png)

この章では、何を確認し、何を避け、GitHub を医療学習と共同作業のための実用的な作業場に変える方法を学びます。
