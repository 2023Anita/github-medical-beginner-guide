---
title: "1-2. 명령어보다 프로젝트 읽기 먼저"
description: "1-2. 명령어보다 프로젝트 읽기 먼저"
---

# 1-2. 명령어보다 프로젝트 읽기 먼저

![1-2. 명령어보다 프로젝트 읽기 먼저](/assets/illustrations/04-repository-reading-order.png)
